...
import { getChatRealtimeMetricsSnapshot } from "../../../libs/chat_realtime_metrics";
...
export const chatRealtimeMetrics = async (_req: Request, res: Response) => {
  return formatResponse({
    res,
    success: true,
    body: {
      chat_realtime_metrics: getChatRealtimeMetricsSnapshot(),
    },
  });
};
