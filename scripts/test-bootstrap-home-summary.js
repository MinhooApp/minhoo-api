...
async function testGuestAll() {
  ...
  assert(Number(body.sections.posts.size) === 20, `Guest posts.size expected 20, got ${body.sections.posts.size}`);
  assert(Number(body.sections.reels.size) === 20, `Guest reels.size expected 20, got ${body.sections.reels.size}`);
  assert(Number(body.sections.services.size) === 20, `Guest services.size expected 20, got ${body.sections.services.size}`);
  assert(Number(body.sections.notifications.limit) === 20, `Guest notifications.limit expected 20, got ${body.sections.notifications.limit}`);

  assert(Number(body.sections.notifications.unreadCount) === 0, "Guest notifications unreadCount must be 0");
  assert(Array.isArray(body.sections.notifications.items), "Guest notifications.items must be array");
...
async function testAuthAll() {
  ...
  assert(Number(body.sections.posts.size) === 20, `Auth posts.size expected 20, got ${body.sections.posts.size}`);
  assert(Number(body.sections.reels.size) === 20, `Auth reels.size expected 20, got ${body.sections.reels.size}`);
  assert(Number(body.sections.services.size) === 20, `Auth services.size expected 20, got ${body.sections.services.size}`);
  assert(Number(body.sections.notifications.limit) === 20, `Auth notifications.limit expected 20, got ${body.sections.notifications.limit}`);
